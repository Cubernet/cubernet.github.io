...
💡 <b>研究兴趣</b>：我们团队的研究聚焦于可信人工智能技术，主要是研究AI自身的安全，偶尔用AI研究传统安全。 <br>    
✨ <b>招生期望</b>：如果你算法扎实、能写会算、表达清楚，还愿意把事情做“到位、做漂亮”，我们会很合拍。<br>   
🎯 <b>培养目标</b>：经过精心组织的科研训练，使学生具备扎实的专业知识、缜密的科研思维、较强的动手能力、广阔的学术视野，及独立发现问题、思考问题、解决问题的科学素养；在校期间在世界顶级期刊或会议上发表高水平、有影响力的论文，并有志于毕业后继续从事可信人工智能相关领域的工作。<br> 
🤝 <b>我的承诺</b>：作为一线科研工作者，我将为你的成长提供全方位支持，包括但不限于：1）<s>亲自指导算法设计、代码实现、实验设计、论文撰写、专利申请、成果展示等全过程</s>（我自认为目前大模型在coding以及文本呈现上已经远超我的个人能力，因此在这一条内容上，目前我仅能起到提供古法科研时代的有限经验以及成果署名“吉祥物”的作用）；2）提供积极向上的科研氛围、舒适的工作环境、稳定的科研经费与高性能计算资源；3）绝对不会让你处理报账、递送材料、拿快递等与科研无关的事务性工作，让你专注科研；4）对于在顶会上发表论文的学生，会提供经费积极资助你参会（只要没出地球并且未被“强敌”火力覆盖）； 5）对表现优秀的同学，我会积极推荐工作或深造机会，助你拓展未来发展路径。
<br><br>
⚠️ <b>特别提醒</b>：<span style="color:red">课题组欢迎真正热爱科研、喜欢探索、乐于挑战、想学知识的同学加入。如果你只是单纯想通过读研获得学位上的提升，建议谨慎考虑，否则在这个过程中我们双方都会很难受。</span>
